...
function checkReset(){
	alert("Reset");
	window.open("/FinalProject/jsp/changeUserPassword.jsp","_self")
}
<%
...
<div>
<form action=/FinalProject/changePassword name=myform method=post>
...
<table>
<tr><td>Login Id</td><td><%= request.getParameter("loginid")%></td></tr><input type="hidden" id="userName" name="userName" value="<%= request.getParameter("loginid")%>">
